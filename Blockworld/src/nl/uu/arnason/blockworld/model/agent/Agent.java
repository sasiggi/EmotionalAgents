...
public final class Agent {
    ...
    public static final AgentBuilder makeBuilder(final AgentModel model){
        return new AgentBuilder()
                .addContext(model)
                .addExternalTriggerPlanScheme(makeModelUpdatePlanScheme());
    }
    ...
    private static final FunctionalPlanSchemeInterface makeModelUpdatePlanScheme(){
